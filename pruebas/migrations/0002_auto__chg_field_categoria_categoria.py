...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Categoria.categoria'
        db.alter_column('pruebas_categoria', 'categoria', self.gf('django.db.models.fields.CharField')(max_length=30))
    
    
    def backwards(self, orm):
        
        # Changing field 'Categoria.categoria'
        db.alter_column('pruebas_categoria', 'categoria', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 14, 28, 46, 800803)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 14, 28, 46, 800658)'}),
